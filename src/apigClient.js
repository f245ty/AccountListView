...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://k8bto0c6d5.execute-api.ap-northeast-1.amazonaws.com/auth';
    ...
    apigClient.ownerGet = function (params, body, additionalParams) {
        ...
        return apiGatewayClient.makeRequest(ownerGetRequest, authType, additionalParams, config.apiKey);
    };
